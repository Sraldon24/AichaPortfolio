    ...
    window.SelectFilter = {
        init: function (field_id, field_name, is_stacked) {
            ...
            quickElement(
                'p',
                selector_available_title,
                interpolate(gettext('Choose %s by selecting them and then select the "Choose" arrow button.'), [
                    field_name,
                ]),
                'class',
                'helptext'
            ...
            quickElement(
                'p',
                selector_chosen_title,
                interpolate(gettext('Remove %s by selecting them and then select the "Remove" arrow button.'), [
                    field_name,
                ]),
                'class',
                'helptext'
