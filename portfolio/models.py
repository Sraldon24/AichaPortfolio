...
class Artwork(models.Model):
    ...
    image = models.ImageField(upload_to='artwork/', help_text="Main primary image")
    image_2 = models.ImageField(upload_to='artwork/', blank=True, null=True, help_text="Optional secondary image")
